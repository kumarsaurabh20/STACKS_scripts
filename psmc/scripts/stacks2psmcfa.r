...
#============parameters============#
f.tag<-"SPA10.tags.tsv"	# name of the tag file
f.allele<-"SPA10.alleles.tsv"	# name of the allele file

f.output<-"SPA10.psmcfa"	# name of the output file
